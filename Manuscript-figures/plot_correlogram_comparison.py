...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 25 17:10:27 2021

@author: lizz
"""


corr, lags, ci = nifl.Xcorr1D(xys[0], series_func=runoff_func, series_dates=d_interp, 
...
corrT, lagsT, ciT = nifl.Xcorr1D(xys[0], series_func=termini_func, series_dates=tm_d_interp, 
                          velocity_pred=preds[0], t_grid=t_grid, t_limits=(2009,2017), 
