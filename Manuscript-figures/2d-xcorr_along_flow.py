...
smb_offset=7000 # how many 'meters' above topo to plot this line
runoff_offset=5000 
...
ax.set(xlim=(25, 0), ylim=(-1300, 8000), aspect=0.002, 
        ...
        yticklabels=('-1000', '0', '1000 m a.s.l.', 
                     ...
                     'Runoff',
                     'SMB'))
minor_locator = FixedLocator([terminus_offset-0.5*scaling, terminus_offset+0.5*scaling, 
